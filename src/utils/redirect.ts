...
export const getIntentUrl = (params): IIntentUrl | undefined => {
	...
	switch (a_rtype || rtype) {
		...
		case 'highlight': // 하이라이트 재생
			...
			break;
		case 'tab_menu': // 탭 메뉴 바로가기 ( 마이컷, 선물함 추가)
			// TODO: 안에 여러 케이스로 나눠서 각 다른 링크 만들어야함
